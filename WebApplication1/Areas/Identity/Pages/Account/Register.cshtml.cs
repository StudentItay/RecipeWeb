    ...
    public class RegisterModel : PageModel
    {
        ...
        private async Task<bool> SendEmailAsync(string email, string subject, string confirmLink)
        {
            try
            {
                ...
                message.From = new MailAddress("itayedriitay@gmail.com");//אם האיימיל המקורי שלי זה עובד
                ...
                smtpClient.Credentials = new NetworkCredential("itayedriitay@gmail.com", "1AFDADFAC8A5597A8217C7620AD35D39DAA4");//הכנסת שם המשתמש והסיסמא למשתנים שלא יהיו חשופים ואולי שינוי של האיימיל הפרטי שלי
